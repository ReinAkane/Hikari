...
namespace HikariThreading
{
    ...
    public class Hikari : UnityEngine.MonoBehaviour
    {
        ...
        /// If Hikari had already been started, the old Hikari will be destroyed.
        /// </summary>
        /// <returns>The spawned game object for Hikari.</returns>
        public static UnityEngine.GameObject Spawn ( )
        {
            // Destroy if it is there.
            if ( hikari != null )
                Destroy(hikari.gameObject);
        ...
        public static ActionTask Schedule ( Action<ActionTask> to_schedule )
        {
            ActionTask t = new ActionTask(to_schedule, false);
        ...
        /// <returns>The task that was added.</returns>
        public static EnumeratorTask Schedule ( System.Collections.IEnumerator to_schedule )
        {
            EnumeratorTask t = new EnumeratorTask(to_schedule, false);
            Instance.threadManager.EnqueueTask(t);
            return t;
        }
        ...
        /// <param name="to_schedule">The method to run in the task.</param>
        /// <returns>The task that was added.</returns>
        public static ActionTask ScheduleUnity ( Action<ActionTask> to_schedule )
        {
            ActionTask t = new ActionTask(to_schedule, true);
        ...
        /// <param name="to_schedule">The enumerator to run in the task.</param>
        /// <returns>The task that was added.</returns>
        public static EnumeratorTask ScheduleUnity ( System.Collections.IEnumerator to_schedule )
        {
            EnumeratorTask t = new EnumeratorTask(to_schedule, false);
            Instance.unityManager.EnqueueTask(t);
            return t;
        ...
        public static ActionTask SpawnDedicatedTask ( Action<ActionTask> task )
        {
            ActionTask t = new ActionTask(task, true);
        ...
        /// <returns>The new dedicated task.</returns>
        public static EnumeratorTask SpawnDedicatedTask ( System.Collections.IEnumerator task )
        {
            EnumeratorTask t = new EnumeratorTask(task, true);
            Instance.threadManager.SpawnDedicatedThread(t);
            return t;
        }
